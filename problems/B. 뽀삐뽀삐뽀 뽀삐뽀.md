...
한성냥이를 도와 릴스를 최소 몇 번 촬영해야 하는지 계산하는 프로그램을 작성하시오.

## 입력

첫째 줄에 흰색 닭을 마주친 횟수 $W$, 갈색 닭을 마주친 횟수 $B$, 표시가 있는 닭을 마주친 횟수 $M$이 주어진다. $(1 \leq W, \space B \leq 1,000, \space M \leq W + B)$

## 출력

첫째 줄에 릴스를 촬영해야 하는 최소 횟수를 출력한다.
